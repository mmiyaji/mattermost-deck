...
export function useAppText() {
  ...
  return useMemo(() => ({
    ...
    threadLayoutCompactStatus: t("deck.threadLayoutCompactStatus"),
    threadLayoutCollapsedStatus: t("deck.threadLayoutCollapsedStatus"),
    threadLayoutRestoredStatus: t("deck.threadLayoutRestoredStatus"),
